if (typeof JEIAddedEvents === "undefined") {
    console.warn("[KubeJS] Skipping alchemy handlers: JEIAddedEvents is unavailable.")
} else {
if (!global.__jeiCategories) global.__jeiCategories = {}
if (!global.__jeiCategories.alchemy) global.__jeiCategories.alchemy = {
    recipeType: null,
    resources: {
        energyEmpty: null,
        energyFull: null,
 ...
 */
global.__jeiCategories.alchemy.loadResources = function(guiHelper) {
 ...
 * @returns
 */
global.__jeiCategories.alchemy.handlers.verifyRecipe = function (jeiHelpers, recipe) {
 ...
 */
global.__jeiCategories.alchemy.handlers.setRecipe = function (jeiHelpers, builder, recipe, focuses) {
 ...
 * @param {number} mouseY
 */
global.__jeiCategories.alchemy.handlers.draw = function (jeiHelpers, recipe, recipeSlotsView, guiGraphics, mouseX, mouseY) {
    global.__jeiCategories.alchemy.resources.energyEmpty.draw(guiGraphics, 5, 44);
    global.__jeiCategories.alchemy.resources.energyFull.draw(guiGraphics, 5, 44);
    global.__jeiCategories.alchemy.resources.alchemyArrow.draw(guiGraphics, 60, 44);
 ...
 */
global.__jeiCategories.alchemy.handlers.tooltips = function (jeiHelpers, recipe, recipeSlotsView, mouseX, mouseY) {
