...
//substrates[current_category[id, ingredient, outputitem]]
    ...
    */
    ...
    category()
    reagent(0x7F7F7F, 0xD4D4D4, "wool", "Woollen", "#minecraft:wool", "minecraft:white_wool")
    reagent(0xA6A6A6, 0xD5D5D5, "iron", "Iron", "#c:dusts/iron", "oritech:iron_dust")
    ...
    reagent(0x232456, 0x7C95A4, "lead", "Leaden", "#c:dusts/lead", "immersiveengineering:dust_lead")
    ...
    reagent(0x616A60, 0xD0D2C5, "zinc", "Zinc", "#c:dusts/zinc", "kubejs:zinc_dust")
    reagent(0xC7A94A, 0xEEF071, "sulfur", "Sulfuric", "#c:dusts/sulfur", "immersiveengineering:dust_sulfur")
    reagent(0x735A65, 0xB8AFAF, "niter", "Nitric", "#c:dusts/saltpeter", "immersiveengineering:dust_saltpeter")
    ...
    reagent(0xFCCED0, 0xDD7E5D, "coral", "Coral", "#minecraft:corals", "minecraft:brain_coral")
    ...
    reagent(0xDD7E5D, 0x17E9AB, "copper", "Copper", "#c:dusts/copper", "oritech:copper_dust")
    ...
    reagent(0x585858, 0x646363, "concrete", "Concrete", "#c:concrete_powder", "clayworks:concrete_powder")
    reagent(0xD5EDC3, 0xE9F4E5, "aluminum", "Aluminum", "#c:dusts/aluminum", "immersiveengineering:dust_aluminum")
    ...
    reagent(0xD99413, 0xFAF25E, "gold", "Golden", "#c:dusts/gold", "oritech:gold_dust")
    ...
    reagent(0x977756, 0xE4D196, "nickel", "Nickel", "#c:dusts/nickel", "oritech:nickel_dust")
    category()
